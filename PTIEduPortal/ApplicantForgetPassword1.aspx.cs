...
public partial class ApplicantForgetPassword : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            ltrMessage.Text = "An Error Occured while retriving your email address:  Confirm that you enter the correct Form Number/User name above. <br /> If you have any difficulty opening your mail box visit the ICT Center or send a mail to itsupport@dlc.ui.edu.ng";
        }
        finally
        {
