                            ...
                            <td>
                                <table align="center" class="style2">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:Panel ID="PanelCannotPrint" runat="server">
                                                <a href="StudentControlCenter.aspx">(IF YOUR PASSPORT IS NOT YET UPLOADED YOU CAN'T PRINT)</a>
                                            </asp:Panel>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <table class="style1" id ="tableICE" runat ="server">
                                                <tr>
                                                    <td class="style43">
                                                        &nbsp;</td>
                                                    <td class="style39">
                                                ...
                                                <tr>
                                                    <td class="style43">
                                                        &nbsp;</td>
                                                    <td class="style40">
                                                        Choose and register for each semester - one after another: Print your current 
                                                        completed form before you choose the next semester to register :</td>
                                                    <td class="style41" style="text-align: left">
                                                        <asp:DropDownList ID="ddlICESemesters" runat="server" AutoPostBack="True" 
                                                            onselectedindexchanged="ddlICESemesters_SelectedIndexChanged" 
                                                            style="color: #CC3300; font-weight: 700">
                                                      <%--  <asp:ListItem  >Semester 1 of 6</asp:ListItem>
                                                         <asp:ListItem  >Semester 2 of 6</asp:ListItem>011/ICE/FLC/BUS 016/0082
                                                          <asp:ListItem  >Semester 3 of 6</asp:ListItem>
                                                           <asp:ListItem  >Semester 4 of 6</asp:ListItem>
                                                            <asp:ListItem  >Semester 5 of 6</asp:ListItem>
                                                             <asp:ListItem  >Semester 6 of 6</asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                                            </td>
                                                ...
                                                <tr>
                                                    <td class="style43">
                                                        &nbsp;</td>
                                                    <td class="style44">
                                                        ALL SEMESTERS MUST BE REGISTERED</td>
                                                    <td class="style41">
                                                        &nbsp;</td>
                                                    <td>
                                                        &nbsp;</td>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" align="left" class="colorheader">
                                            <asp:ObjectDataSource ID="odsDeptCourses" runat="server" SelectMethod="getSessionCourses"
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:Panel ID="PanelCannotPrint2" runat="server">
                                                <a href="StudentControlCenter.aspx">(YOU MUST UPLOAD YOUR PASSPORT BEFORE YOU CAN PRINT!)</a>
                                            </asp:Panel>
