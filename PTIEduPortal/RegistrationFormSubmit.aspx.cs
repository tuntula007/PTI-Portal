...
public partial class RegistrationFormSubmit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == true)//ICE
        {
            if (RegistrableCourseGridView.Rows.Count > 0)
            { RegistrableCourseGridView.Visible = true; }
            if (grdCarryOver.Rows.Count > 0)
            { grdCarryOver.Visible = true; }
            //lblTotCredit.Text = 


                //string i=Session["totCredit"].ToString();
                //lblTotCredit.Text = i.ToString();

                string i = Session["SemesterCredit"].ToString();
                lblTotCredit.Text = i.ToString();
        }
        if (Page.IsPostBack == false)
        {
            Session["SemesterCredit"] = 0;
            ...
            if (MatricNumber.Contains("ICE"))
            {
                if ((students.AcademicLevel == "ND I") || (students.AcademicLevel == "HND I"))
                {
                //this.ddlICESemesters.Items.Add("---Select a semester ---");
                //this.ddlICESemesters.Items.Add("Semester 1 of 6");
                //this.ddlICESemesters.Items.Add("Semester 2 of 6");
                //this.ddlICESemesters.Items.Add("Semester 3 of 6"); 
                }

                if ((students.AcademicLevel == "ND II") || (students.AcademicLevel == "HND II"))
                {
                    //this.ddlICESemesters.Items.Add("---Select a semester ---");
                    //this.ddlICESemesters.Items.Add("Semester 4 of 6");
                    //this.ddlICESemesters.Items.Add("Semester 5 of 6");
                    //this.ddlICESemesters.Items.Add("Semester 6 of 6");
                }
                //tableICE.Visible = true;
                RegistrableCourseGridView.Visible = false;

            }
            //if (!(MatricNumber.Contains("ICE")))
            //{ tableICE.Visible = false; }
           ...
           // if (DeptCoursesBusiness.getRegistrationStatus(students.MatricNumber, Semester, crSession) == true)
            ...
            try
            {
                ...
                Session["MinCreditLoad"] = 2; // MinCreditLoad = DeptCoursesBusiness.getSemesterCoursesMinCredit(students.CourseOfStudyID, students.AcademicLevel, Semester, students.ModeOfStudy, students.Programme);
                Session["MaxCreditLoad"] = 1000; // MaxCreditLoad = DeptCoursesBusiness.getSemesterCoursesMaxCredit(students.CourseOfStudyID, students.AcademicLevel, Semester, students.ModeOfStudy, students.Programme);
                ...
                int SemesterCredit = DeptCoursesBusiness.getSessionCoursesTotalCredit(students.CourseOfStudyID, students.AcademicLevel,students.DepartmentID, students.Programme, students.ModeOfStudy);
                this.RegistrableCourseGridView.ToolTip ="CURRENT SESSION CREDIT LOAD = " +SemesterCredit.ToString();
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        ...
        if(MatricNumber.Contains ("ICE"))// PART-TIME studen
        //{ Semester = ddlICESemesters.Text; }
        ...
        try
        {
            ...
            foreach (GridViewRow r in RegistrableCourseGridView.Rows)
            {
                ...
                if (chkrow.Checked)
                {
                   ...
                   // isRegistered = DeptCoursesBusiness.Register(st.MatricNumber, Semester, coursecode,coursetype, courseunit, CurrentSes);
                    ...
                    // track ICE:
                    if (Semester.Contains("1 of 6")) { Semester = "First"; }
                    if (Semester.Contains("2 of 6")) { Semester = "Second"; }
                    if (Semester.Contains("3 of 6")) { Semester = "Third"; }

                    if (Semester.Contains("4 of 6")) { Semester = "First"; }
                    if (Semester.Contains("5 of 6")) { Semester = "Second"; }
                    if (Semester.Contains("6 of 6")) { Semester = "Third"; }
            ...
            if (isRegistered == true)
            {
               ...
               lblTotCredit.Text = Session["SemesterCredit"].ToString();
    ...
    protected void ckTickedCourse_CheckedChanged(object sender, EventArgs e)
    {
       ...
       // if ( unitLoaded==0)// at first page loag
        ...
        // update semestercredit:
        Session["SemesterCredit"] = CarryOverCredit;
    ...
    protected void ddlICESemesters_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (MatricNumber.Contains("ICE"))// PART-TIME studen
        {

            //if (ddlICESemesters.SelectedValue =="Semester 1 of 6")
              // { Semester = "First";}
            //if (ddlICESemesters.SelectedValue =="Semester 2 of 6")
              // { Semester = "Second";}
            //if (ddlICESemesters.SelectedValue =="Semester 3 of 6")
              //  { Semester = "Third";}
            ////////////////////////////
            //if (ddlICESemesters.SelectedValue =="Semester 4 of 6")
              //  { Semester = "First";}
            //if (ddlICESemesters.SelectedValue =="Semester 5 of 6")
                //{ Semester = "Second"; }
            //if (ddlICESemesters.SelectedValue =="Semester 6 of 6")
              //  { Semester = "Third"; }
            Session["Semester"]=Semester;
            if (RegistrableCourseGridView.Rows.Count > 0)
            { RegistrableCourseGridView.Visible =true ; }
