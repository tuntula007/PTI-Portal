...
public partial class PinEntry : System.Web.UI.Page
{
    ...
    protected void BtnLogin_Click(object sender, EventArgs e)
    {
      ...
      // LIVE ND I 25500:6878946071571    ND II 14500,HND II 14500:  4917974758918  HND I 14500: 4077944690570    GW: 8931443883488                                    
        ...
        SkuFeePinComment = Pvr.FailureComment;
         ...
         if( (SkuFeePinVerified) && (St.AcademicLevel =="HND II") && !(Pvr.PinValue =="12000")  )
         {
             PanelError.Visible = true;
         ...
         if ((SkuFeePinVerified) && (St.AcademicLevel == "ND II") && !(Pvr.PinValue == "12000"))
         {
             PanelError.Visible = true;
         ...
         if ((SkuFeePinVerified) && (St.AcademicLevel == "ND I") && !(Pvr.PinValue == "25500"))
         {
             if(!St.RegNo.Contains( "PRE"))
             {
                 PanelError.Visible = true;
                 LblError.Text = "Wrong School Fees:This PIN is not for ND I students !!!";
                 logger.Info(St.MatricNumber + "_Wrong School Fees:This PIN is not for ND I students !!!");
