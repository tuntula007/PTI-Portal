...
public partial class StudentLogin : System.Web.UI.Page
{
    ...
    protected void BtnLogin_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string EncodedString = Server.HtmlEncode(So.MatricNumber);
            string UrlEncodedString = Server.UrlEncode(So.MatricNumber);
            Response.Redirect("StudentControlCenter.aspx?MatricNumber=" + UrlEncodedString, false);
        }
        catch (Exception ex)
        {
