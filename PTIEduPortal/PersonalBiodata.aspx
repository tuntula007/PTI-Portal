                                                        ...
                                                        <td align="left">
                                                            <table class="tablepersonal" cellpadding="2" cellspacing="2">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <asp:DropDownList ID="cmbDay" runat="server" Enabled ="false">
                                                                        ...
                                                                        <asp:DropDownList ID="cmbMonth" runat="server" Enabled ="false">
                                                                        ...
                                                                        <asp:DropDownList ID="cmbYear" runat="server"  Enabled ="false">
