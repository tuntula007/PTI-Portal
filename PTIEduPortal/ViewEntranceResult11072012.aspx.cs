...
public partial class ViewEntranceResult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if( Ao.Programme.Contains ("HND"))   //// HND does not have exam scores only Admission status via intervie:
    ...
    private void RefreshForm()
    {
        ...
        ObjGrid.SelectMethod = "GetEntranceRawScoresByFormNo";
        ...
        try
        {
            ...
            if (GridView2.Rows.Count < 1)
            {
                ...
                LblError.ForeColor = Color.Red;
                GridView2.Visible = false;
                LblError.Text = "NO SCORES FOUND FOR " + Param.ToUpper();
                new Utility().MessageBox(LblError.Text, this.Page);
                LblError.Visible = true;
                LblStud.Text = "";
    ...
    private void RefreshForm(string Surname, string SecondName, string PhoneNumber, string Email)
    {
        ...
        ObjGrid.SelectMethod = "GetEntranceRawScoresByBiodata";
        ...
        try
        {
            ...
            if (GridView2.Rows.Count < 1)
            {
                ...
                GridView2.Visible = false;
                LblError.ForeColor = Color.Red;
                LblError.Text = "NO SCORES FOUND FOR " + (Surname + " " + SecondName).ToUpper();
                new Utility().MessageBox(LblError.Text, this.Page);
                LblError.Visible = true;
                LblStud.Text = "";
                LblStud.Visible = false;
    ...
    protected void GridView2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("RptPrintNotification.aspx");

    }
    protected void LnkShoww_Click(object sender, EventArgs e)
    {
        //LinkButton Btt = (LinkButton)GridView2.Rows[GridView2.SelectedIndex].FindControl("LnkShow");
        //Session["RegNo"] = Btt.Text;
        //Response.Redirect("RptPrintAdmissionLetterN.aspx");
    }
