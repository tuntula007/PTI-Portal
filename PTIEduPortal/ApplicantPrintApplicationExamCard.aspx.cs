...
public partial class ApplicantPrintApplicationExamCard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            txtOthersubjects.Text = applicants.EntranceExamsubj1.ToString().ToUpper();
            ...
            lblDLCFirstChoice.Text = "1. "+applicants.CourseofStudy1+"</br>"
                                    +"2. "+applicants.CourseofStudy2+"</br>"
                                    +"3. "+applicants.CourseofStudy3;
