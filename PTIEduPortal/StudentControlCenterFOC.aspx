<%@ Page Language="C#" MasterPageFile="~/MasterPageform.master" AutoEventWireup="true"
    CodeFile="StudentControlCenterFOC.aspx.cs" Inherits="StudentControlCenterFOC" Title="Deltas University College Portal  - Students Control Centre" %>
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="204" class="controlcentermenu">
                                        ...
                                        <tr>
                                            <td id="SemesterReg" runat="server" background="images/button.gif" align="left" class="style6">
                                                <strong><a href="RegistrationForm.aspx" onclick="return CheckCanRegister('<% = Server.HtmlEncode(this.CanRegister(1)) %>','1');"
                                                    style="margin-left: 5px">Course Registration</a></strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td background="images/button.gif" align="left" height="28">
                                                <strong><a href="javascript:openwin();" onclick="return CheckRegistered('<% = Server.HtmlEncode(this.isRegistered(1)) %>','1');"
                                                    style="margin-left: 5px">Print Registration Form</a></strong>
                                            </td>
                                        </tr>
                                        <tr id="trExamClearance" runat="server" visible="false">
                                            <td background="images/button.gif" align="left" height="28">
                                                <strong><a href="ExamClearanceForm.aspx" style="margin-left: 5px">Exam Clearance Form</a>
                                                </strong>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="trLibraryForm" runat="server" visible="false">
                                            <td background="images/button.gif" align="left" height="28">
                                                <strong><a href="javascript:openwinLibrary()" style="margin-left: 5px">Library Registration
                                                    Authorisation</a> </strong>
                                            </td>
                                        </tr>
                                        <tr id="trStudentID" runat="server" visible="false">
                                            <td background="images/button.gif" align="left" height="28">
                                                <strong><a href="javascript:openwinStudentId();" style="margin-left: 5px">My ID Card</a></strong>
                                            </td>
                                        </tr>
                                        <tr id="trCourseMaterial" runat="server" visible="True">
                                            <td background="images/button.gif" align="left" height="28">
                                                <strong><a href="ContentGallery.aspx" style="margin-left: 5px">My Course Materials</a>
                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr id="trPayStatus" runat="server">
                                            <td background="images/button.gif" align="left" height="28">
                                                <strong><a id="lnkPayStatus" runat="server" href="#" style="margin-left: 5px">
                                                    <asp:Label ID="lblPayStatus" runat="server" Text="Payment Receipt" /></a></strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top">
                                    <p align="left" style="font-family: Arial; font-size: 13px">
                                        <b>DeltasUniversity Portal - Students Control Center </b>
                                    </p>
                                ...
                                <td colspan="2">
                                    <table border="0" cellpadding="2" cellspacing="2" width="90%" class="controlcentertext">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label ID="lbldlcmail" runat="server" Text="deltasmail"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
