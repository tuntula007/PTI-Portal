                        ...
                        <tr>
                            ...
                            <td width="58%">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="topmainmenu">
                                    <tr>
                                        <td width="34%">
                                            <a href="Default.aspx">Website Home</a>
                                        </td>
                                        <td width="42%">
                                             <a href="mailto:info@pti.edu.ng">Need Help? Contact Us</a>
                                        </td>
                                        <td width="18%">
                                            <a href="#">FAQ</a>
                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="93%" class="style2">
                                                        <span class="style4">Welcome, to logon page.
                                                            <br />
                                                            Enter your Matric.No as Password to log in to Student Control Center . 
                                                        Then Click On Change Password to change your default password</span><br />
                                                        <br />
                                                      ...
                                                      <%--  For Newly Admitted Student new to the Portal, Sign Up <a href="SignOn.aspx">Here</a>
                                                        first<br />--%>
                                                        If you have an existing account and you can't logon, you can click here to find a
