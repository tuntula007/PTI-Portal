                    ...
                    <asp:Panel ID="PanelGrid" runat="server" Font-Names="Tahoma" Font-Size="Small" Height="1147px"
                        ...
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CourseOfStudy2" HeaderText="ExamCenter">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="TotalScore" HeaderText="TotalScore">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="EntranceSubject1" HeaderText="General  Paper">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="EntranceSubject2" HeaderText="First Subject">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="EntranceSubject3" HeaderText="Second Subject">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                            </Columns>
