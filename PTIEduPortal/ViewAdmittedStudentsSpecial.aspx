                    ...
                    <asp:Panel ID="PanelGrid" runat="server" Font-Names="Tahoma" Font-Size="Small" Height="1147px"
                        ...
                        <table id="SimpleSearch" runat="server">
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    <asp:TextBox ID="txtSearch" runat="server" Width="673px" Enabled="False"></asp:TextBox>
                        ...
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="CONGRATULATIONS !">
                                    <ItemTemplate>
                                            <asp:LinkButton ID="LnkShoww" runat="server" CausesValidation="False" CommandName="Select"
                                            OnClick="LnkShoww_Click" Text="Print Page 1 and Page 2 of your Admission Letter" ToolTip="YOU MUST HAVE PAID FOR A =N=1000 ADMISSION LETTER PIN AT THE BANK BEFORE YOU CAN PRINT YOUR ADMISSION LETTER"></asp:LinkButton>
                                        <%-- 
                                         <asp:LinkButton ID="LnkShoww" runat="server" CausesValidation="False" CommandName="Select"
