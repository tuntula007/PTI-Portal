...
public partial class ViewAdmittedStudentsSpecial : System.Web.UI.Page
{
    ...
    {ApplicantSignOn Ao=new ApplicantSignOn();
        ...
        if (this.GridView2.Rows.Count < 1)
        {
            this.txtSearch.Text = "ADMISSION LIST IS BEING PUBLISHED.PLEASE CHECK BACK TO KNOW IF YOU MEET THE REQUIREMENT";
        }
        //RefreshForm();
    }
    private void RefreshForm()
    {
        ...
        if (string.IsNullOrEmpty(txtSearch.Text.Trim()) == true)
        {
            ...
            LblError.Text = "SORRY! THIS CANDIDATE HAS NO ADMISSION INFORMATION";
