    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (App.PresentSession.ToLower() != ApplicantsBusiness.ActiveSession().ToLower())
            {
                ...
                new Utility().MessageBox("Dear " + App.RegNo + ",THE PORTAL IS BEING UPDATED " +
                    App.PresentSession + " PLEASE CHECK BACK A COUPLE OF MINUTES LATER", "ApplicantLogin.aspx", this.Page);
                return;
