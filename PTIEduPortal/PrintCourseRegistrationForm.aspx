                    ...
                    <table class="style1">
                                                ...
                                                <table class="tablepersonal" cellpadding="2" cellspacing="10">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" class="style35">
                                                            :<asp:Label ID="lblyear" runat="server" Text="year" Font-Bold="True"
                                                                Font-Size="14pt" Visible="False"></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style28">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" class="style35">
                                                            ...
                                                            <asp:Label ID="lblacademiclevel" runat="server" Text="courselevel" Font-Bold="True" Visible ="false"
                                                        ...
                                                        <td>
                                                            <asp:GridView ID="CourseForm1GridView" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Semester" HeaderText="SEMESTER" ItemStyle-CssClass="gridcol3"
                                                                        SortExpression="Semester">
                                                                        <ItemStyle CssClass="gridcol3" />
                                                                    </asp:BoundField>                                                                        
                                                                    <asp:TemplateField HeaderText="APPROVAL STATUS">
                                                                        <ItemTemplate>
                                                                            <asp:Image ImageUrl="Images/Approved.jpg"  ID="AprovStatus" runat="server" />
                                                                            <asp:Label ID="lblAprovalStatus" Text="APPROVED" runat="server"></asp:Label>
                                                                          </ItemTemplate>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:ObjectDataSource ID="odsDeptCourses1" runat="server" SelectMethod="getSessionCourses"
                                    TypeName="CybSoft.EduPortal.Business.DeptCoursesBusiness" 
