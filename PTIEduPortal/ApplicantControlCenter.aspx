                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="204" class="controlcentermenu">
                                        ...
                                        <tr> 
                                            <td background="images/button.gif" class="style1" height="28">
                                                <strong> 
                                                    <a href="ViewEntranceResult.aspx">
                                                    <asp:Label ID="Label2" runat="server" Text="Check Entrance Result" 
                                                    Visible="true"></asp:Label></a>
                                                </strong>
                                            </td>
                                        </tr>
                                        ...
                                        <tr> 
                                            <td background="images/button.gif" class="style1" height="28">
                                                <strong>
                                                <%--<a href="RptPrintNotification.aspx">--%> 
                                                    <a href="ViewAdmittedStudentsSpecial.aspx">
                                        ...
                                        <tr>
                                            <td background="images/button.gif" class="style1" height="28">
                                               <%-- <a href="#" onclick="LnkShoww_Click">
                                                    <asp:Label ID="Label3" runat="server" Text="Print Admission Letter" 
                                                    Visible="true" ></asp:Label></a>--%>
                                                    
                                                    
                                             <asp:LinkButton ID="LnkShoww" runat="server" CausesValidation="False" CommandName="Select"
                                            OnClick="LnkShoww_Click" Text="Print Admission Letter"></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td background="images/button.gif" class="style1" height="28">
                                                <strong><a href="ApplicantProfile.aspx">Manage Profile</a> </strong>
                                            </td>
                                        </tr>
