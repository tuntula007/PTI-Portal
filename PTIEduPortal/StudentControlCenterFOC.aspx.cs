...
public partial class StudentControlCenterFOC : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["MatricNumber"] != null)
        {
            ...
            lbldlcmail.Text = Stud.DLCMail; lbldlcmail.ToolTip = "logon to mail.deltasuniversity.com to check your mail box"; lbldlcmail.Font.Bold = true;
