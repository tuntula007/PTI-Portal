...
<head>
    ...
    <title>Deltas University Portal  - Sign up</title>
...
<body bgcolor="#ffffff">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="93%">
                                                        <p>
                                                            <span style="color: #0000FF">For Old/Returning Student new to the Portal, Enter your detail below to Sign Up</span><br />
                                                            <br />
                                                            For Newly Admitted Student who have not sign on before, Sign Up <a href="SignOn.aspx">
                                                                Here</a><br />
   ...
   &nbsp;<asp:TextBox ID="txtMatricNo" CssClass="shorttextBox" runat="server"></asp:TextBox></td>
                                        <td width="32%" height="41">
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td height="15" colspan="4" align="center">
                                            <asp:Panel ID="PanelError" runat="server" BackColor="White" Visible="False" Width="301px">
                                                ...
                                                &nbsp;
                                                    <label>
                                                        <asp:HyperLink ID="LnkLogin" runat="server" Font-Bold="True" Font-Names="Tahoma"
                ...
                <td colspan="8" class="bottombarbg">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="97%">
                                For technical queries, send Email to itsupport@deltasuniversity.com
                    </table>
                </td>
                <td>
