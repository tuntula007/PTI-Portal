<%@ Page Language="C#" MasterPageFile="~/Admission/AdmissionMasterPage.master" AutoEventWireup="true"
    CodeFile="PostUmeExamDate.aspx.cs" Inherits="Admin_PostUmeExamDate" %>
...
<ContentTemplate>
                                    <asp:Panel ID="PaymentTypePanel1" runat="server" GroupingText="Post UME Exam Date"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td nowrap="nowrap">
                                                                            <asp:DropDownList ID="DDListModeStudy" runat="server" AutoPostBack="True" 
                                                                                OnSelectedIndexChanged="DDListModeStudy_Changed" style="width: 77px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td nowrap="nowrap">
                                                                        </td>
                                                            ...
                                                            <td colspan="4">
                                                                <table>
                                                                    <tr valign="top">
                                                                        <td>
                                                                            School Programmes
                                                                            <asp:Panel ID="Panel10" runat="server" Height="175px" Width="150px" BorderStyle="Solid"
                                                                                ScrollBars="Both">
