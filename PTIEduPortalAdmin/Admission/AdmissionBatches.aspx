<%@ Page Language="C#" MasterPageFile="~/Admission/AdmissionMasterPage.master" AutoEventWireup="true" CodeFile="AdmissionBatches.aspx.cs" Inherits="Admin_AdmissionBatches" %>
                                    ...
                                    <asp:Panel ID="PaymentTypePanel1" runat="server" Width="100%">
                                        <table cellpadding="2" cellspacing="0">
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtBatches" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
