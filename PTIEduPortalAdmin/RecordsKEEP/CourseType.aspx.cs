...
public partial class Admin_CourseType : System.Web.UI.Page
{
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        {
            TxtCourseType.Text = TreeView1.SelectedValue.ToString();
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (TxtCourseType.Text != "")
            {
                TxtCourseType.Text = TxtCourseType.Text.ToUpper().Replace("'", "''").Replace("=", "").Trim(); //.Replace("STATE", "").Trim();
            }
            else
            {
                msg = "Enter course type";
                showmassage(msg);
                TxtCourseType.Focus();
                return;
            }
            ...
            string Qry = "SELECT * FROM [CourseTypes] where [CourseType] = '" + TxtCourseType.Text.Trim() + "'";

            if (Existed(Qry))
            {
                msg = "Course type existed before";
                showmassage(msg);
                TxtCourseType.Focus();
                return;
            }
            ...
            {
                Qry = "INSERT INTO [CourseTypes]([CourseType]) VALUES ('" + TxtCourseType.Text.Trim() + "')";
                PerformInsert(Qry);
            }
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (TxtCourseType.Text != "")
            {
                TxtCourseType.Text = TxtCourseType.Text.Trim().ToUpper().Replace("'", "''");
            }
            else
            {
                msg = "Enter course type";
            ...
            string qry = "Delete from [CourseTypes] where [CourseType] ='" + TxtCourseType.Text.Trim() + "'";
