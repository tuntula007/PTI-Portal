<%@ Page Language="C#" MasterPageFile="~/Records/RecordsMasterPage.master" AutoEventWireup="true" CodeFile="EntryMode.aspx.cs" Inherits="Admin_EntryMode" %>
                                                ...
                                                <td>
                                                    <table style="position: relative; z-index: auto; overflow: auto; float: left; table-layout: auto">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtEntryMode" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtDescription" runat="server" SkinID="mediumTxt" TabIndex="1" 
