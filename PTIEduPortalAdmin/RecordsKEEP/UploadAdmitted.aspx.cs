...
public partial class Admin_UploadAdmitted : System.Web.UI.Page
{
    ...
    ////private static ApplicationClass xl = null;// new ApplicationClass();
    ////private static Workbook wb = null;
    ////private static Sheets exsht = null;
    ////private static Worksheet wks = null;
    ////private static Range exrange, cell = null;
    ...
    private void LoadFile(string fname)
    {
        ...
        try
        {
            if (fname != "")
            {
                ...
                switch (ext.ToLower().Trim())
                {
                    ...
                    case ".xlsx":
                        ...
                        ////filepath = Server.MapPath("~/Received/" + FileUpload2.FileName);
                        ...
                        File.Copy(filepath, Localpath1 + fname, true);
                        // TreatFileXls(Localpath1, fname, Payitem, Payitemtype, Taxation, PayitemtCode, ext);
            ...
            ////GridView1.Width = 3000;
            //////TreeView1.Nodes.Clear();
            ////TreeView1.Height = 1000;
            ////TreeView1.ExpandDepth = 0;
            ////PanelAdmin.GroupingText = "Admitted Students Per Session";
