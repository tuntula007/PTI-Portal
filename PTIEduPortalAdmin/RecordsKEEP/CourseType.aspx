<%@ Page Language="C#" MasterPageFile="~/Records/RecordsMasterPage.master" AutoEventWireup="true" CodeFile="CourseType.aspx.cs" Inherits="Admin_CourseType" %>
                    ...
                    <td>
                        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" OnActiveTabChanged="TabContainer1_ActiveTabChanged"
                            ...
                            <ajaxToolkit:TabPanel runat="server" HeaderText="" ID="TabPanel1">
                                <HeaderTemplate>
                                    Add  Course Type</HeaderTemplate>
                                <ContentTemplate>
                                    <asp:Panel ID="PaymentTypePanel1" runat="server" Width="100%">
                                        <table cellpadding="2" cellspacing="0">
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtCourseType" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
