<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Bursary/BursaryMasterPage.master"
    CodeFile="RptOrderUsageParam.aspx.cs" Inherits="RptOrderUsageParam" Title="CON Usage Reports" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=10.5.3700.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="Panel1" runat="server" Font-Names="Tahoma" Font-Size="Small" Width="95%">
        <table style="width: 100%">
            <tr>
                <td colspan="2" style="font-size: large">
                    CONFIRMATION ORDER USAGE REPORT FORM
                </td>
            </tr>
            <tr>
                <td class="style10" style="text-align: left; width: 193px;">
                    Report Type:
                </td>
                <td style="text-align: left">
                    <asp:DropDownList ID="CmbRtype" runat="server">
                        <asp:ListItem Value="SchoolFeesPin">School Fees</asp:ListItem>
                        <asp:ListItem Value="ApplicationFeesPin">Application Fees</asp:ListItem>
                        <asp:ListItem>Students Total Payment</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
