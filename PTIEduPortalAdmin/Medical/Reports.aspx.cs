...
public partial class Reports : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            DDListReportType.Items.Add("All Medical");
            DDListReportType.Items.Add("Individual Medical");
    ...
    {
        //Individual Id Card
        if (DDListReportType.Text.Trim() == "Individual Medical")
        {
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            query = "select ([Surname] + ' '+ [OtherNames]) as [Names],[MatricNumber],[CourseOfStudyName] as [Course Of Study] FROM [Students] where [Surname]  like '%" + TxtSearch + "%' or [OtherNames]  like '%" + TxtSearch + "%' or [MatricNumber]  like '%" + TxtSearch + "%' or [Email]  like '%" + TxtSearch + "%' or [PhoneNumber]  like '%" + TxtSearch + "%' or [AcademicLevel]  like '%" + TxtSearch + "%' or [RegNo]  like '%" + TxtSearch + "%' or [CourseOfStudyName] like '%" + TxtSearch + "%' or [Programme] like '%" + TxtSearch + "%' or [Honours] like '%" + TxtSearch + "%' or [ModeOfStudy] like '%" + TxtSearch + "%' or [Title] like '%" + TxtSearch + "%'";
