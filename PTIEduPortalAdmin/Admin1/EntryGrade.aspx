<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="EntryGrade.aspx.cs" Inherits="Admin_EntryGrade" Title="Untitled Page" %>
                                    ...
                                    <asp:Panel ID="PaymentTypePanel1" runat="server" Width="100%">
                                        <table cellpadding="2" cellspacing="0">
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtGrade" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
