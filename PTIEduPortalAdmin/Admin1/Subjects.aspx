<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Subjects.aspx.cs" Inherits="Admin_Subjects" Title="Untitled Page" %>
                                                ...
                                                <td>
                                                    <table style="position: relative; z-index: auto; overflow: auto; float: left; table-layout: auto">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtSubject" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
