<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Dept.aspx.cs" Inherits="Setup_Faculty" Title="Faculty" %>
                                                ...
                                                <td>
                                                    <table style="position: relative; z-index: auto; overflow: auto; float: left; table-layout: auto">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtDeptCode" runat="server" SkinID="mediumTxt" TabIndex="1"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtHod" runat="server" SkinID="mediumTxt" TabIndex="2"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
