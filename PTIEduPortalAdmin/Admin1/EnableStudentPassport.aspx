<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="EnableStudentPassport.aspx.cs" Title="Enable Student Passport" Inherits="Admin_EnableStudentPassport" %>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblPassport" runat="server" Width="300px"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="btnUpdatePassport" runat="server" 
                                        OnClick="btnUpdatePassport_Click" Text="Enable Passport" Visible="False" />
                                </td>
                            </tr>
                        </table>
                    </td>
