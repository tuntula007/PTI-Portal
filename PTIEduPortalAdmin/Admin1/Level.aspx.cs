...
public partial class Admin_Level : System.Web.UI.Page
{
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        {
            TxtLevels.Text = TreeView1.SelectedValue.ToString();
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (TxtLevels.Text != "")
            {
                TxtLevels.Text = TxtLevels.Text.ToUpper().Replace("'", "''").Replace("=", "").Trim(); //.Replace("STATE", "").Trim();
            }
            else
            {
                msg = "Enter Level";
            ...
            string Qry = "SELECT * FROM [Levels] where [AcademicLevel] = '" + TxtLevels.Text.Trim() + "'";

            if (Existed(Qry))
            {
                msg = "Level existed before";
                showmassage(msg);
                TxtLevels.Focus();
                return;
            }
            else
            {
                ...
                Qry = "INSERT INTO [Levels]([AcademicLevel],[CreatedDate],[CreatedBy]) VALUES ('" + TxtLevels.Text.Trim() + "','" + date + "','" + ID + "')";
                PerformInsert(Qry);
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (TxtLevels.Text != "")
            {
                TxtLevels.Text = TxtLevels.Text.Trim().ToUpper().Replace("'", "''");
            }
            else
            {
                msg = "Enter Level";
            ...
            string qry = "Delete from [Levels] where [AcademicLevel] ='" + TxtLevels.Text.Trim() + "'";
