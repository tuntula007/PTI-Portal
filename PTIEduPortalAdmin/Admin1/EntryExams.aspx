<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="EntryExams.aspx.cs" Inherits="Admin_EntryExams" Title="Untitled Page" %>
                    ...
                    <td>
                        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" OnActiveTabChanged="TabContainer1_ActiveTabChanged"
                            ...
                            <ajaxToolkit:TabPanel runat="server" HeaderText="" ID="TabPanel1">
                                <HeaderTemplate>
                                    Add Entry Exam Name</HeaderTemplate>
                                <ContentTemplate>
                                                ...
                                                <td>
                                                    <table style="position: relative; z-index: auto; overflow: auto; float: left; table-layout: auto">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtExam" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtDescription" runat="server" SkinID="mediumTxt" TabIndex="1"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>                                                        
