<%@ Page Language="C#" MasterPageFile="~/Records/RecordsMasterPage.master" AutoEventWireup="true" CodeFile="Level.aspx.cs" Inherits="Admin_Level" %>
                                    ...
                                    <asp:Panel ID="PaymentTypePanel1" runat="server" Width="100%">
                                        <table cellpadding="2" cellspacing="0">
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtLevels" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
