...
public partial class Createuser : System.Web.UI.Page
{
    ...
    private static string EmailPackagePath = ".\\private$\\" + ConfigurationManager.AppSettings["EmailQ"];    //AudilogPTI
    ...
    protected void cboUsergroup_Changed(object sender, EventArgs e)
    {
        ...
        if (cboUsergroup.Text.Trim().ToLower() == "web master" || cboUsergroup.Text.Trim().ToLower() == "bursary admin" || cboUsergroup.Text.Trim().ToLower() == "bursary operation" || cboUsergroup.Text.Trim().ToLower() == "records" || cboUsergroup.Text.Trim().ToLower() == "admission" || cboUsergroup.Text.Trim().ToLower() == "audit" || cboUsergroup.Text.Trim().ToLower() == "help desk")
        {
    ...
    protected void btnCreateaccount_Click(object sender, EventArgs e)
    {
        ...
        if (Group.ToUpper() == "WEB MASTER")
        {
            ...
            //    validuser = true;
            //}
            if (cboUsergroup.Text.Trim().ToUpper() == "BURSARY ADMIN" || cboUsergroup.Text.Trim().ToUpper() == "BURSARY OPERATION" || cboUsergroup.Text.Trim().ToUpper() == "AUDIT" || cboUsergroup.Text.Trim().ToUpper() == "HELP DESK" || cboUsergroup.Text.Trim().ToUpper() == "ADMISSION" || cboUsergroup.Text.Trim().ToUpper() == "RECORDS")
            {
                fact = "None";
                dept = "None";
                CosOfStudy = "None";
        ...
        try
        {
            ...
            else
            {
                if (validuser == true)
                {
                    ...
                    sbmsgbody.AppendLine("");
                    sbmsgbody.AppendLine("Below are your login credentials for PETROLEUM TRAINING INSTITUTE, EFFURUN Admin portal:");
                    sbmsgbody.AppendLine("");
    ...
    private void sendGenMail(string maillist, string messg, string subject, string Heading, string attachedFile, string StaffName)
    {
        try
        {
            ...
            cm.ReplyTo.Add("softwaredev@cyberspace.net.ng");
    ...
    protected void grdViewStatustory_OnRowUpdating(Object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            string Subject = "Login Credentials";
            string Heading = "PETROLEUM TRAINING INSTITUTE, EFFURUN admin portal updated Login Credentials";
            string Attached = "";
