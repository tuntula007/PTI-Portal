<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="NotificationMails.aspx.cs" Inherits="Admin_NotificationMails" %>
                    ...
                    <td>
                        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" OnActiveTabChanged="TabContainer1_ActiveTabChanged"
                            ...
                            <ajaxToolkit:TabPanel runat="server" HeaderText="" ID="TabPanel1">
                                <HeaderTemplate>
                                    Add Staff Email</HeaderTemplate>
                                <ContentTemplate>
                                                ...
                                                <td>
                                                    <table style="position: relative; z-index: auto; overflow: auto; float: left; table-layout: auto">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtEmail" runat="server" SkinID="mediumTxt"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="TxtStaffName" runat="server" SkinID="mediumTxt" TabIndex="1" 
                                                                    AutoCompleteType="Disabled" Width="350px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>                                                        
