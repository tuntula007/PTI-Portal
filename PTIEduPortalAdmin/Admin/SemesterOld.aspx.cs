...
public partial class Admin_Semester : System.Web.UI.Page
{
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        {
            TxtSemester.Text = TreeView1.SelectedValue.ToString();
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (TxtSemester.Text != "")
            {
                TxtSemester.Text = TxtSemester.Text.ToUpper().Replace("'", "''").Replace("=", "").Trim(); //.Replace("STATE", "").Trim();
            }
            else
            {
                msg = "Enter Semester";
            ...
            {//SELECT * FROM [Semesters] where [Semester] ='" + Semester + "'
                Qry = "INSERT INTO [Semesters]([Semester]) VALUES ('" + TxtSemester.Text.Trim() + "')";
                PerformInsert(Qry);
            }
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (TxtSemester.Text != "")
            {
                TxtSemester.Text = TxtSemester.Text.Trim().ToUpper().Replace("'", "''");
            }
            else
            {
                msg = "Enter Level";
