...
public partial class Admin_CourseApproval : System.Web.UI.Page
{
    ...
    private void LoadCourseOfStudy(string SupId2)
    {
        ...
        try
        {
            ...
            DataSet ds = new DataSet();
            string qry = "";
            //; //use this to store id based on user login
            depID = getidforGroup(ID);
            if (Group.ToLower() != "web master")
            {
            ...
            {
                qry = "SELECT distinct [CourseOfStudyName],[CourseOfStudyID] FROM [CourseOfStudy]  where [ModeOfStudy] ='" + DDListModeStudy.Text.Trim() + "'";
            }
    ...
    private void DisplayGrid()
    {
        try
        {
            ...
            try
            {
                ...
                tb.Columns.Add("CosCode21", typeof(string));
                tb.Columns.Add("CosCode22", typeof(string));
                tb.Columns.Add("CosCode23", typeof(string));
                tb.Columns.Add("CosCode24", typeof(string));
                tb.Columns.Add("CosCode25", typeof(string));
                tb.Columns.Add("CosCode26", typeof(string));
                tb.Columns.Add("CosCode27", typeof(string));
                tb.Columns.Add("CosCode28", typeof(string));
                tb.Columns.Add("CosCode29", typeof(string));
                tb.Columns.Add("CosCode30", typeof(string));
                ...
                if (prog == "All")
                {
                    if (Group.ToLower() != "web master")
                    {
                        sql = "select distinct [MatricNumber] from [CourseRegistration] where [SessionName]='" + DDListSession.Text.Trim() + "' and [AcademicLevel] ='" + DDListLevels.Text.Trim() + "' and [ModeOfStudy] = '" + DDListModeStudy.Text.Trim() + "' and [Programme] = '" + DDListProgramme.Text.Trim() + "' and [IsApproved] = 0 and departmentid =" + depID;
                    }
                    else
                    {
                                        ...
                                        for (int jj = 0; jj < ds.Tables[0].Rows.Count; jj++)
                                        {
                                            ...
                                            switch (jj)
                                            {
                                                ...
                                                case 19:
                                                    ...
                                                    break;
                                                case 20:
                                                    drow["CosCode21"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 21:
                                                    drow["CosCode22"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 22:
                                                    drow["CosCode23"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 23:
                                                    drow["CosCode24"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 24:
                                                    drow["CosCode25"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 25:
                                                    drow["CosCode26"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 26:
                                                    drow["CosCode27"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 27:
                                                    drow["CosCode28"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 28:
                                                    drow["CosCode29"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                                case 29:
                                                    drow["CosCode30"] = ds.Tables[0].Rows[jj][0].ToString();
                                                    break;
                                            }
