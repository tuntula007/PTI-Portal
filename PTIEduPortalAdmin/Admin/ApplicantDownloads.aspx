                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td nowrap="nowrap">
                                                                            <asp:DropDownList ID="DDListLevels" runat="server" Visible="False">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td nowrap="nowrap">
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td>
                                                                            <asp:TextBox ID="TxtStartDate" runat="server" SkinID="mediumTxt" TabIndex="1" 
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td>
                                                                            <asp:TextBox ID="TxtEndDate" runat="server" SkinID="mediumTxt" TabIndex="2" 
                        ...
                        <tr>
                            <td>
                                <table width="100%">
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="lblCaption" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <asp:Panel ID="PanelGrid" runat="server"  GroupingText="Info" HorizontalAlign="Left" Width="1000px" ScrollBars="Both">
                                          <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999"
                                                BorderStyle="Solid" BorderWidth="1px" CellPadding="3" PageSize="1000" AutoGenerateDeleteButton="False"
