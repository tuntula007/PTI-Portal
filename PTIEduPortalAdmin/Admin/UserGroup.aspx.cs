...
public partial class Admin_UserGroup : System.Web.UI.Page
{
    ...
    private void populatetreeview()
    {
        ...
        try
        {
            ...
            string qry = "SELECT [Usergroup] FROM [TUsergroups] order by [Usergroup] asc";
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int jj = 0; jj < ds.Tables[0].Rows.Count; jj++)
                {
                    ...
                    //ChkBoxListStaff2.Items.Add(Staff);
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        {
            TxtUsergroup.Text = TreeView1.SelectedValue.ToString();
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                TxtUsergroup.Text = TxtUsergroup.Text.ToUpper().Replace("'", "''");//.Replace("STATE", "").Trim();
            }
            else
            {
                msg = "Enter User Group";
                showmassage(msg);
                TxtUsergroup.Focus();
                return;
            }
            ...
            string Qry = "SELECT * FROM [TUsergroups] where [Usergroup] = '" + TxtUsergroup.Text.Trim() + "'";

            if (Existed(Qry))
            {
                msg = "User group name existed before, try to edit";
                showmassage(msg);
                TxtUsergroup.Focus();
                return;
            }
            else
            {
                ...
                Qry = "INSERT INTO [TUsergroups]([Usergroup]) VALUES ('" + TxtUsergroup.Text.Trim() + "')";
                PerformInsert(Qry);
    ...
    protected void BtnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (TxtUsergroup.Text != "")
            {
                TxtUsergroup.Text = TxtUsergroup.Text.Trim().ToUpper().Replace("'", "''");
            }
            else
            {
            ...
            string Qry = "SELECT * FROM [TUsers] where [Usergroup] = '" + TxtUsergroup.Text.Trim() + "'";

            if (Existed(Qry))
            {
                msg = "can not be deleted, user assigned already to this group";
                showmassage(msg);
                TxtUsergroup.Focus();
                return;
            }
            ...
            {
                string qry = "Delete from [TUsergroups] where [Usergroup] ='" + TxtUsergroup.Text.Trim() + "'";
