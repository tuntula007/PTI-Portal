<%@ Page Language="C#" MasterPageFile="~/helpdesk/HelpdeskMasterPage.master" AutoEventWireup="true"
    CodeFile="StudentRegistrationStatus.aspx.cs" Title="Registration Status" Inherits="Admin_StudentRegistrationStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="100%">
            <tr><td><h2>CHECK REGISTRATION STATUS</h2></td></tr>
                <tr>
                    <td>
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnSearchParam" runat="server" onclick="btnSearchParam_Click" 
