<%@ Page Title="" Language="C#" MasterPageFile="~/Records/RecordsMasterPage.master"
    AutoEventWireup="true" CodeFile="RptCourseRegistrationDetailed.aspx.cs" Inherits="RptCourseRegistrationDetailed" %>
        ...
        <table style="width: 90%" align="center">
            <tr>
                ...
                <td style="text-align: left">
                    COURSE REGISTRATION DETAILED REPORTS
                </td>
            </tr>
            <tr>
                <td class="style10" style="text-align: left; width: 161px;">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="cmbStudentLevel" runat="server">
                        ...
                        <asp:ListItem>ND I</asp:ListItem>
                        <asp:ListItem>ND II</asp:ListItem>
                        <asp:ListItem>HND I</asp:ListItem>
                        <asp:ListItem>HND II</asp:ListItem>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:CheckBoxList ID="CheckBoxDisplayColumn" runat="server" RepeatColumns="2">
                        ...
                        <asp:ListItem Value=" isnull(S.DLCMail,'')">PTIMail</asp:ListItem>
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
