...
public partial class RptCourseRegDetailShow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DetailCourseRegDt = CourseRegReportBusiness.getCourseRegDetail(ProgrammeCat, Programme, Faculty, Department, Sess, FilterLevel, RptField);
        if (DetailCourseRegDt == null || DetailCourseRegDt.Rows.Count <1)
        {
            ...
            Response.Redirect("~/admin/Reporting/RptCourseRegistrationDetailed.aspx");
            return;
        }
