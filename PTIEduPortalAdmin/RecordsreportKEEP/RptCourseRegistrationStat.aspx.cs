...
public partial class RptCourseRegistrationStat : System.Web.UI.Page
{
    ...
    protected void BtnShow_Click(object sender, EventArgs e)
    {
        ...
        Session["Filter"] = ChkAllFaculty.Checked ? "All" : cmbStdFaculty.SelectedValue;
        Session["Sess"] = CmbSession.Text;
        Response.Redirect("~/Recordsreport/RptCourseRegStatShow.aspx");
