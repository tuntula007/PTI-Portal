...
public partial class RptCourseCodeRegDetailShow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // RptProg += "(" + FilterLevel + " Level)";
        ...
        DetailCourseRegDt = CourseRegReportBusiness.getCourseCodeRegDetail(ProgrammeCat,CourseCode,ProgrammeText, Faculty, Department, Sess, FilterLevel, RptField);
        if (DetailCourseRegDt == null || DetailCourseRegDt.Rows.Count <1)
        {
            Session["ErrorMessage"] = "No Student Course Registration for "
            ...
            Response.Redirect("~/Recordsreport/RptCourseRegistrationByCode.aspx");
            return;
        }
        ReportTitle = "COURSE CODE REGISTRATION REPORT FOR " + Sess.ToUpper() +  " REGISTRATION SESSION " + "(COURSE CODE: " + CourseCode + ")";// FOR STUDENTS OF "
