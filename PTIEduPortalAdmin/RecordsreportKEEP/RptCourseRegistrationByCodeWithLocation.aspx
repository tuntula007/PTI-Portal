<%@ Page Title="" Language="C#" MasterPageFile="~/Records/RecordsMasterPage.master"
    AutoEventWireup="true" CodeFile="RptCourseRegistrationByCodeWithLocation.aspx.cs"
    Inherits="RptCourseRegistrationByCodeWithLocation" %>
        ...
        <table style="width: 90%" align="center">
            <tr>
                ...
                <td style="text-align: left">
                    <span style="font-size: 14px">COURSE REGISTRATION BY COURSE CODE REPORT WITH LOCATION</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="CmbTeachingCenter" runat="server">
                        <asp:ListItem>Effurun</asp:ListItem>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="CmbExamCenter" runat="server">
                        <asp:ListItem>Effurun</asp:ListItem>
                        <asp:ListItem>Delta</asp:ListItem>
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="CmbFaculty" runat="server" DataSourceID="ObjFaculty" DataTextField="FacultyName"
                        DataValueField="FacultyName" OnSelectedIndexChanged="CmbFaculty_SelectedIndexChanged"
                        AutoPostBack="True">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="CmbCourse" runat="server" DataSourceID="ObjCoursesByCategoryFacultyAndDepartment"
                        DataTextField="ProgrammeName" DataValueField="ProgrammeCode" OnSelectedIndexChanged="CmbCourse_SelectedIndexChanged"
                        AutoPostBack="True">
                    </asp:DropDownList>
